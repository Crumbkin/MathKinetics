...
namespace PoseAI
{
    ...
    {     
        ...
        //latermovent scaler
        public float lateralmovementScale = 1.5f;
        ...
        */
        private void AdjustRootLocation()
        {
            ...
            // THIS PART CONTROLS THE LATERALMOVEMENT
            var targetTranslation = new Vector3(0.0f, GetBonePenetration(), 0.0f);
            if (vis.isTorso && scaBody.BodyHeight > 0.0f)
                targetTranslation.x = lateralmovementScale * vecBody.HipScreen[0] * RigHeight / scaBody.BodyHeight * AnimationAlpha * idleAlpha;
