...
namespace PoseAI
{
    ...
    public class PoseAIHandshake
    {
        ...
        public class Handshake
        {
            ...
            public string name = "PoseAI_UnityDemo";
            public string rig;
            public string mode;
            ...
            public string whoami = "PoseAI_UnityDemo";
            public string signature = "PoseAI_UnityDemo";
    ...
    public abstract class PoseAIRigBase
    {
        ...
        public bool OverwriteFromJSON(string jsonString, bool writeState)
        {
    ...
    public class PoseAIEvents
    {
        ...
        public List<EventPairBase> compactOrder;
    }
